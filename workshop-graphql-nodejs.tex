...
\begin{Highlighting}[]
\ImportTok{export} \ImportTok{default} \OperatorTok{\{}
    \DataTypeTok{Odd}\OperatorTok{:}\NormalTok{ OddType}\OperatorTok{,}
\OperatorTok{\}}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Define a scalar type Url and use it in attribute trailer of Movie and
...
\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{export} \KeywordTok{const}\NormalTok{ validateUrl }\OperatorTok{=}\NormalTok{ (str) }\OperatorTok{=>} \OperatorTok{\{}
    \KeywordTok{let}\NormalTok{ pattern }\OperatorTok{=} \KeywordTok{new} \AttributeTok{RegExp}\NormalTok{(}\StringTok{'^(https?:}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{/}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{/)'} \OperatorTok{+} \CommentTok{// protocol}
        \StringTok{'((([a-z}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d]([a-z}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d-]*[a-z}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d])*)}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{.?)+[a-z]\{2,\}|'} \OperatorTok{+} \CommentTok{// domain name}
        \StringTok{'((}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d\{1,3\}}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{.)\{3\}}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d\{1,3\}))'} \OperatorTok{+} \CommentTok{// OR ip (v4) address}
        \StringTok{'(}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{:}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d+)?(}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{/[-a-z}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d%_.~+]*)*'} \OperatorTok{+} \CommentTok{// port and path}
        \StringTok{'(}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{?[;&a-z}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d%_.~+=-]*)?'} \OperatorTok{+} \CommentTok{// query string}
        \StringTok{'(}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{#[-a-z}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d_]*)?$'}\OperatorTok{,} \StringTok{'i'}\NormalTok{)}\OperatorTok{;} \CommentTok{// fragment locator}
    \ControlFlowTok{return} \VariableTok{pattern}\NormalTok{.}\AttributeTok{test}\NormalTok{(str)}\OperatorTok{;}
\OperatorTok{\}}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{\{}
  \DataTypeTok{"data"}\FunctionTok{:} \FunctionTok{\{}
    \DataTypeTok{"rate"}\FunctionTok{:} \FunctionTok{\{}
      \DataTypeTok{"realRate"}\FunctionTok{:} \DecValTok{3}
    \FunctionTok{\},}
    \DataTypeTok{"movie"}\FunctionTok{:} \FunctionTok{\{}
      \DataTypeTok{"customRate"}\FunctionTok{:} \DecValTok{15}
    \FunctionTok{\}}
  \FunctionTok{\}}
\FunctionTok{\}}
\end{Highlighting}
